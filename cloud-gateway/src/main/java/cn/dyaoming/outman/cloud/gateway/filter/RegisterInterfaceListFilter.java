...
//@Slf4j
//@Component
//public class RegisterInterfaceListFilter implements GlobalFilter, Ordered {
//
//	@Autowired
...
//			} else {
//				throw new AppServiceException("未经过系统审核通过的业务接口，interfaceId=\"" + interfaceId + "\"");
//			}
//		} catch (Exception e) {
//			e.printStackTrace();
